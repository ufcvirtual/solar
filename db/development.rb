...
allocations = Allocation.create([
    ...
    {:user_id => 1, :allocation_tag_id => 9, :profile_id => 12, :status => 1},
    ...
    {:user_id => 6, :allocation_tag_id => 6, :profile_id => 12, :status => 1},
    ...
    {:user_id => 7, :allocation_tag_id => 3, :profile_id => 12, :status => 1},
    ...
    {:user_id => 8, :allocation_tag_id => 3, :profile_id => 12, :status => 1},
