...
models = [Lesson, Allocation, AllocationTag, Permission, Resource, Profile, Group, Enrollment, Offer, CurriculumUnit, CurriculumUnitType, Course, PersonalConfiguration, User]
