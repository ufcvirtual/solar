class AssignmentCommentsController < ApplicationController
  ...
  def download
    ...
    raise CanCan::AccessDenied unless Assignment.owned_by_user?(current_user.id, { sent_assignment: file.assignment_comment.sent_assignment }) || is_observer_or_responsible
