class ChatRoomsController < ApplicationController
  ...
  def messages
    ...
    raise CanCan::AccessDenied if (all_participants.any? and all_participants.joins(:user).where(users: {id: current_user}).empty?) and not(@chat_room.responsible?(allocation_tag_id, current_user.id))
