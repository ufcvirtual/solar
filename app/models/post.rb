  ...
  def self.reorder_by_latest_posts(discussion_id, posts) 
    unless posts.empty? 
      ...
      posts = posts.sort{|post1, post2|
        ...
        ((!lp_info2.nil? and lp_info2["date"] > post2.updated_at) ? lp_info2["date"] : post2.updated_at) <=> ((!lp_info1.nil? and lp_info1["date"] > post1.updated_at) ? lp_info1["date"] : post1.updated_at)
      }
    end
