...
class AssignmentTest < ActiveSupport::TestCase
  ...
  test "informacoes das atividades que um aluno participa - atividades individuais" do
    ...
    user_id       = (assignments(:a3).type_assignment == Group_Activity) ? nil : users(:aluno1).id 
  ...
  test "informacoes das atividades que um aluno participa - atividades em grupo" do
    ...
    user_id       = (assignments(:a6).type_assignment == Group_Activity) ? nil : users(:aluno1).id 
    assert_nil user_id
  ...
  test "data final de avaliacao deve ser igual ou maior do que a data final da atividade" do 
    assignment = Assignment.create(:end_evaluation_date => schedules(:schedule27).end_date - 3.month, :allocation_tag_id => allocation_tags(:al3).id, :schedule_id => schedules(:schedule27).id, :name => "assignment 1", :enunciation => "assignment 1", :type_assignment => Individual_Activity)
  ...
  test "periodo da atividade deve fazer parte do periodo da oferta" do 
    assignment = Assignment.create(:schedule_id => schedules(:schedule15).id, :allocation_tag_id => allocation_tags(:al3).id, :enunciation => "assignment 1", :type_assignment => Individual_Activity)
