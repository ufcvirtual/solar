...
class  DiscussionTest < ActiveSupport::TestCase
  ...
  test "novo forum deve ter titulo unico para a mesma allocation_tag" do
    discussion1 = Discussion.create(:name => "discussion name", :description => "discussion description", :schedule_id => schedules(:schedule24).id)
    assert discussion1.valid?

    discussion2 = Discussion.create(:name => "discussion name", :description => "discussion description", :schedule_id => schedules(:schedule24).id)
