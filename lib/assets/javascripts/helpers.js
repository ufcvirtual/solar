...
$.fn.call_fancybox = function (options) {
  ...
  **/
  ...
  $.extend( options, { live: false, modal: false, helpers: { overlay: { locked: false, closeClick: false }, autoDimensions: true, width: '100px' } } );
  ...
  for(name in CKEDITOR.instances){
    ...
    if ((typeof content != 'undefined') && (!displayNone)) {
      ...
      if ( (content == "<p><br></p>" || content == "") && (count > 0) ) {
          //if (confirm(I18n.t('questions.form.items.empty', { count: " + count + " }))) {
          if (confirm("O item " + count + " está em branco, deseja excluí-lo?")) {
