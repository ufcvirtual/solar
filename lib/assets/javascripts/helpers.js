...
function flash_message(msg, css_class, div_to_show, onclick_function) {
  div_to_show = (typeof div_to_show == "undefined") ? $(".flash_message_wrapper:last") : $("." + div_to_show);
...
$.fn.call_fancybox = function (options) {
  ...
  **/
  $.extend( options, { live: false, modal: false, helpers: { overlay: { locked: true, closeClick: false } } } );
