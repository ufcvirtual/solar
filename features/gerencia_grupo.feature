...
#INCOMPLETO
@javascript @wip
Cenário: Gerenciar grupos - salvar alterações
    Dado que estou logado com o usuario "prof" e com a senha "123456"
        E que estou em "Meu Solar"
    Quando eu clicar no link "Quimica I"
        Então eu deverei ver "Atividades"
    ...
    Quando eu clicar no link "Grupos"
        Então eu deverei ver "Atividade em grupo I"
    Quando eu clicar no item "Atividade em grupo I" de id "4"
        Então eu deverei ver o botao "Gerenciar grupos"
    Quando eu clicar em "Gerenciar grupos"
        Então eu deverei ver o elemento de id "text_field_group_1"
        E eu deverei ver o elemento de id "remove_group_1"
        E eu deverei ver "Aluno 1"
        E eu deverei ver "Aluno 2"
        E eu deverei ver o botao "Novo grupo"
        E eu deverei ver o botao "Salvar"
        E eu deverei ver o botao "Cancelar"
        #E eu nao deverei ver o botao "Gerenciar grupos"
    Quando eu clicar em "Novo grupo"
        Então eu deverei ver o elemento de id "edit_group_new_0"
    Dado que eu preenchi "text_field_group_new_0" com ""
        E que eu arrastei ".student_8" de "#div_assignment_4" para "#ul_no_group" em "#no_students_message"
        Quando eu clicar em "Salvar"
        E eu clicar em "Ok" no popup
            Então eu deverei ver "Nome do grupo deve ser preenchido(a)"
    Dado que eu preenchi "text_field_group_new_0" com "grupo 4"
        Quando eu clicar em "Salvar"
        E eu clicar em "Ok" no popup
            E eu espero ate que a chamada ajax seja concluida
            E eu deverei ver "Grupos gerenciados com sucesso"
            #E eu deverei ver ".student_8" em "#ul_no_group"

@javascript
Cenário: Gerenciar grupos - cancelar alterações
    Dado que estou logado com o usuario "prof" e com a senha "123456"
        E que estou em "Meu Solar"
    Quando eu clicar no link "Quimica I"
        Então eu deverei ver "Atividades"
    ...
    Quando eu clicar em "Novo grupo"
        Então eu deverei ver o elemento de id "edit_group_new_0"
    Dado que eu preenchi "text_field_group_new_0" com ""
        E que eu arrastei ".student_8" de "#div_assignment_4" para "#ul_no_group"
        Quando eu clicar em "Cancelar"
        E eu clicar em "Ok" no popup
            Entao eu espero ate que a chamada ajax seja concluida
            E eu deverei ver "Alterações canceladas"
            E eu deverei ver ".student_8" em "#group_ul_1"