...
Cenário: Cadastrar novo usuário
    Dado que estou em "Cadastrar usuario"
       E que eu preenchi "Nome" com "teste"
       E que eu preenchi "CPF" com "123456"
       E que eu preenchi "Sexo" com ""
       E que eu selecionei a data "13/12/2010" no campo com id "user_birthdate"
       E que eu preenchi "Necessidades Especiais" com ""
       ...
       E que eu preenchi "Apelido" com ""
       E que eu preenchi "Email" com ""
       E que eu preenchi "Login" com ""
       E que eu preenchi "Senha" com ""
    Quando eu clicar em "Salvar"
    Então eu deverei ver "Usuário criado com sucesso."
